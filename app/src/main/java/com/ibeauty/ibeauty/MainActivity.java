    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Snackbar.make(v, "Menu Snackbar", Snackbar.LENGTH_LONG).setAction("Action",null).show();
            }
        });
...
//        tabLayout.addTab(tabLayout.newTab().setText("TAB D"));
